...
//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
  ...
  totaltva=0;
  final imageJpg =
  (await rootBundle.load('assets/images/client.jpg')).buffer.asUint8List();
  ...
  RichText(text: TextSpan(
  children: [
  TextSpan(text: 'Moyen de Transport : ',style:TextStyle(fontSize: 12, fontWeight: FontWeight.bold) ),
  ...
  RichText(text: TextSpan(
  children: [
  TextSpan(text: 'Nom De Chauffeur : ',style:TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
